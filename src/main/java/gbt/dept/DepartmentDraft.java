 ...
 * @generated
 */
@Entity(id = "entity:gbt.dept.DepartmentDraft", table = "dpt_base_info_draft", autoIndex = false)
public class DepartmentDraft implements Serializable {
	private static final long serialVersionUID = 854382780612608L;
	/**
	 *单位id
	 */
